...
const App = () => {
  ...
  const [filter, setFilter] = useState({ numbers: true, highestAlphabet: true });
      ...
      <div className="filter-section">
        ...
        <div className="filters">
          <span className={`filter-chip ${filter.numbers ? 'active' : ''}`}>
            Numbers
            <button className="close-button" onClick={() => toggleFilter('numbers')}>x</button>
          </span>
          <span className={`filter-chip ${filter.highestAlphabet ? 'active' : ''}`}>
            Highest Alphabet
            <button className="close-button" onClick={() => toggleFilter('highestAlphabet')}>x</button>
          </span>
        </div>
      </div>
